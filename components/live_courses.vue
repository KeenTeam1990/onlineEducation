<template>
	<view>
		<view class="product" :class="className">
			<view class="product-item" v-for="(item, index) in list" :key="index" @click="open(item._id)">
				<view class="image">
				...
				<view class="info">
					...
					<view class="price" v-if="hasBuy!=true">
