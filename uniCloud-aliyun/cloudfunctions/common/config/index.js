module.exports = {
	"uni":{
		"passwordSecret": "yGTn6gH670eeKg0t",// 加密密码所用的密钥，修改会导致所用户之前的密码失效。如一定要修改，请查看https://uniapp.dcloud.io/uniCloud/uni-id?id=modifysecret
		"tokenSecret": "qg9rItKuOcnZxocM",			// 生成token所用的密钥，修改会导致所有用户之前的token失效。
		...
		"mp-weixin": {
			"oauth" : {
				...
				"weixin" : {
					"appid" : "wx4b6b111483a092c0",
					"appsecret" : "7cd11d7150cc3b3a567f9fec90bce412"
				}
			}
		},
		"mp-alipay": {
		...
		"service": {
			// unicloud短信
			"sms": {
				"name": "短信验证",										// 应用名称，对应短信模版的name
				"codeExpiresIn": 180,							// 验证码过期时间，单位为秒，注意一定要是60的整数倍
				"smsKey": "a453e861738874e5bb785ae60e092141",						// 短信密钥key，开通短信服务处可以看到 https://dev.dcloud.net.cn/uniSms
				"smsSecret": "fcf950d5d4a954de3a92dc9b772a416e",			// 短信密钥secret，开通短信服务处可以看到 https://dev.dcloud.net.cn/uniSms
				"templateId":"11592"				// 短信模板ID
			},
			// 一键登录
			"univerify": {
